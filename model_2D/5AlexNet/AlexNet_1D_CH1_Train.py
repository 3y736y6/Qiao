...
summaryWriter = SummaryWriter(f"./runs/alexnet/{formatted_datetime}")
...
model = AlexNet_1D_CH1_SRC.AlexNet1D(in_channels=1, classes=class_num).to(device=device)
...
print('AlexNet_time:{}min'.format((end-start)/60))
    
torch.save(model, '5AlexNet\model\model_AlexNet1D.pth')
