...
summaryWriter = SummaryWriter(f"./runs/densenet/{formatted_datetime}")
...
model = DenseNet_1D_SRC.DenseNet(in_channels=1, classes=class_num).to(device=device)
...
print('DenseNet_time:{}min'.format((end-start)/60))
    
torch.save(model, '4Densenet\model\model_Densenet1D.pth')
