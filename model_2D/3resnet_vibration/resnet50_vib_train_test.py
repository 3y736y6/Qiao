...
from resnet_src import resnet34,resnet50,resnet101,resnet18
...
def main(my = True,train = True,test = True,color_channel = 3):
    ...
    dataset = MyDataset2(data_file='STFT2D_data.pkl', label_file='STFT2D_label.dat')
    #dataset = MyDataset2(data_file='Wavelet2D_data_Reshape.pkl', label_file='Wavelet2D_label.dat')
...
if __name__ == '__main__':
    main(my = False,train=True,test=True)