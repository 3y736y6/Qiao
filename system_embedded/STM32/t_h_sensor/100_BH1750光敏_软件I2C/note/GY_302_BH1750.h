...
//掉电具体实现 --> void Get_LIght_Intensity(void){}在此函数定义中加上void BH1750_Power_OFF(void)函数
...
#define SCL_PORT_ENABLE      __HAL_RCC_SCL_PORT_CLK_ENABLE();     /* SDA所在PORT使能 */
#define SDA_PORT_ENABLE      __HAL_RCC_SDA_PORT_CLK_ENABLE();     /* SDA所在PORT使能 */
/*----------------------------------------------------------------------------------------------------------*/
