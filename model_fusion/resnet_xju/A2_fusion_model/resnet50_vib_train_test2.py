...
def main(my = True,train = True,test = True,color_channel = 1):
    ...
    dataset1 = MyDataset2(data_file='xju_STFT2D_data.pkl', label_file='label_5.dat')

        # dataset = MyDataset2(data_file='xju_Wavelet2D_data_shape128.pkl', label_file='label_5.dat') 
    dataset2 = MyDataset2(data_file='xju_wavelet2D_shape2048.pkl', label_file='label_5.dat') 
    ...
    if train == True:
        ...
        for epoch in range(epochs):
            ...
            for i, ((data1, target1), (data2, target2)) in enumerate(zip(train_loader1, train_loader2)):
                ...
                # ------------------------
                images2, labels2 = data2,target2 # 数据不同标签相同 
