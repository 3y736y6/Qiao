...
data_path ={ 'normal':'./data/N1_30.MAT',
             'broken':'./data/B1_30.MAT',
             'missing_tooth':'./data/M1_30.MAT',
             'root_crack':'./data/R1_30.MAT',
             'wear':'./data/W1_30.MAT'
            } 
...
with open('bj_30hz_1channel_1D_data.csv','w') as file:
    for i in data_list:
        i = str(i) 
